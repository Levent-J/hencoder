    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe keyframe3 = Keyframe.ofFloat(1f,100);

                PropertyValuesHolder holder = PropertyValuesHolder.ofKeyframe("progress",keyframe0,keyframe1,keyframe2,keyframe3);
